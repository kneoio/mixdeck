...
const columns = computed<DataTableColumns<any>>(() => {
  ...
  return [
    ...
    { title: t('playlistView.col_type'), key: 'type', width: 160, render: (row) => row.type ? h(NTag, { size: 'small', style: 'max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap' }, { default: () => t(`fragmentForm.type_${row.type.toLowerCase()}`, row.type) }) : '-' },
    {
