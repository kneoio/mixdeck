export default {
  ...
  dj: {
    ...
    chat_close: 'Close',
    chat_empty: 'Ask the DJ what to say between these two songs.',
    chat_placeholder: 'Type a message…',
    chat_send: 'Send',
    chat_error: 'Could not reach the DJ',
    chat_script_label: 'Proposed script',
    chat_use_script: 'Use this script',
    chat_generating: 'Generating…',
    chat_used_script: 'Voice generated and placed on the timeline',
