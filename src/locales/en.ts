export default {
  ...
  dj: {
    ...
    lane_voice: 'Voice',
    lane_drag: 'Drag in time',
    lane_fade: 'Music volume',
    lane_fade_hint: 'Fade curve',
    fade_hint: 'Double-click the volume lane to add a point, double-click a point to remove it.',
    auto_duck: 'Auto duck',
    reset_curve: 'Reset curve',
    delete_rec: 'Delete recording',
    rec_hint: 'Press REC to record your link',
    window: 'Preview / send window',
    vocal_in: 'Vocal in',
    overrun: 'Your voice runs {seconds}s past the vocal entry',
    rec: 'REC',
    rec_stop: 'Stop',
