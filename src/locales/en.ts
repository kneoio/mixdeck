export default {
  ...
  dj: {
    ...
    lane_tail: 'Outro',
    lane_head: 'Intro ramp',
    lane_voice: 'Link',
    voice_source_rec: 'REC',
    voice_source_ai: 'AI',
    voice_source_file: 'EFFECT',
    ...
    range_start: 'Start of the play / send range',
    range_end: 'End of the play / send range',
    rec: 'REC',
    rec_stop: 'Stop',
    preview: 'Play',
    preview_stop: 'Stop',
    ...
    song_error: 'Could not load the song',
    mic_error: 'Microphone unavailable or recording failed',
    sent: 'Link sent to air',
    send_error: 'Could not send the link to air',
    chat_open: 'Chat with DJ',
    chat_title: 'Chat with the DJ',
    chat_title_named: 'Chat with {name}',
    chat_empty: "Your station's DJ works for you while you hold the air — ask for an intro, an announcement or a song.",
    chat_placeholder: 'Message the DJ…',
    chat_connecting: 'Connecting…',
    chat_send: 'Send',
    chat_suggestion_1: "Introduce me — I'm taking over the air",
    chat_suggestion_2: "What's playing and what's next?",
    chat_suggestion_3: 'Queue something upbeat after my link',
    no_a: 'No song A — this link opens with your voice straight into C',
    no_c: 'No song C — this link ends with your voice after A',
