export default {
  ...
  otsListView: {
    ...
    delete_confirm: '{count} Stream-Preset(s) löschen?',
    deleted: '{count} Stream-Preset(s) gelöscht',
  },
  otsForm: {
    title: 'Stream-Preset',
    create_subtitle: 'Stream-Preset erstellen',
    edit_title: 'Stream-Preset bearbeiten',
    edit_subtitle: 'Stream-Preset aktualisieren',
    ...
    load_failed: 'Das Stream-Preset konnte nicht geladen werden.',
    saved: 'Stream-Preset gespeichert',
