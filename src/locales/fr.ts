export default {
  ...
  otsListView: {
    ...
    delete_confirm: 'Supprimer {count} preset(s) de stream ?',
    deleted: '{count} preset(s) de stream supprimé(s)',
  },
  otsForm: {
    title: 'Preset de stream',
    create_subtitle: 'Créer un preset de stream',
    edit_title: 'Modifier le preset de stream',
    edit_subtitle: 'Mettre à jour le preset de stream',
    ...
    load_failed: 'Échec du chargement du preset de stream.',
    saved: 'Preset de stream enregistré',
